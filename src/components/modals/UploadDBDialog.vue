...
<template>
	<NModal :closable="!submitData.processing" :show="dialogs.submitLyric" :title="t('uploadDBDialog.title')"
		...
		<NSpace style="line-height: 2rem; white-space: pre-line;" vertical>
			...
			<NAlert v-if="!hasMusicId" type="warning">
				<i18n-t keypath="uploadDBDialog.noMusicIdWarning"/>
			</NAlert>
			<NAlert v-if="!hasMusicName" type="warning">
				<i18n-t keypath="uploadDBDialog.noMusicNameWarning"/>
			</NAlert>
			<NAlert v-if="!hasArtists" type="warning">
				<i18n-t keypath="uploadDBDialog.noArtistWarning"/>
			</NAlert>
			<NAlert v-if="!hasAlbum" type="warning">
				<i18n-t keypath="uploadDBDialog.noAlbumWarning"/>
			</NAlert>
		</NSpace>
		<template #footer>
