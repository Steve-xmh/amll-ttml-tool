	...
	<NModal :show="dialogs.settings" :title="t('settingsDialog.title')" mask-closable preset="card"
		...
		<NTabs animated type="line">
			<NTabPane key="common" :name="t('settingsDialog.tab.common')" class="setting-grid">
				...
				<div>
					<div>
						<i18n-t keypath="settingsDialog.common.timeOffset"/>
					</div>
					<div class="desc">
						<i18n-t keypath="settingsDialog.common.timeOffsetDesc"/>
					</div>
				</div>
				<div>
			...
			<NTabPane key="shortcut" :name="t('settingsDialog.tab.keybindings')" class="setting-grid">
				...
				<div>
					<i18n-t keypath="settingsDialog.keybindings.setLineStartTime"/>
				</div>
				<div>
					<ShortcutInput v-model="settings.keybindings.setLineStartTime" :default="['KeyV']"/>
				</div>
				<div>
					<i18n-t keypath="settingsDialog.keybindings.setLineEndTime"/>
				</div>
				<div>
					<ShortcutInput v-model="settings.keybindings.setLineEndTime" :default="['KeyN']"/>
				</div>
			</NTabPane>
		</NTabs>
	</NModal>
