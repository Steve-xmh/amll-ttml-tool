                ...
                <NSteps vertical>
                    ...
                    <NStep title="保存歌词">
                        <NSpace vertical>
                            ...
                            <div>但是目前只有 Lyricify Syllable 格式可以保留所有信息，导出成 LRC 格式会丢失逐词歌词的单词信息和歌词行属性信息，而导出成 YRC/QRC
                                格式会丢失歌词行的属性信息，要留意哦！</div>
                        </NSpace>
                    </NStep>
                    <NStep title="使用歌词">
                        <NSpace vertical>
                            <div>最后就是放到 AMLL 插件的 TTML 歌词文件夹内，将歌词文件命名为网易云的歌曲 ID（可以通过 AMLL 播放页面内右键复制得到）后重新切歌即可读取！</div>
                            <div>为了让更多人能够体验到 TTML 歌词带来的效果，您也可以将您的歌词上传到 <a
                                    href="https://github.com/Steve-xmh/amll-ttml-db">SteveXMH 的 TTML 歌词仓库</a>上，供大家下载使用哦！
                            </div>
                        </NSpace>
                    </NStep>
                </NSteps>
